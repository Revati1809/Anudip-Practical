...
public class JDBCEXAMPLE {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Step 4: Insert Data
            insertData(connection, 15, "John ", "rutjohn@ex.com");
            insertData(connection, 14, "Jane ", "devjane@ex.com");
            ...
            // Step 6: Update Data
            updateData(connection, 3, "john.doe.sunne@exampl.com");

            // Step 7: Delete Data
            deleteData(connection, 7);

            // Step 8: Search Data
            searchData(connection ,15);
